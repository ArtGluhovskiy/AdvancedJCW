...
public class ControllerConstants {
    ...
    public static final String LOGIN_VIEW = "login/main";
    public static final String REGISTRATION_MAIN_VIEW = "registration/main";
    public static final String APPLICATION_VIEW = "application";
    public static final String COMPILATION_FAILED_VIEW = "compilation-failed";
    public static final String COMPILATION_SUCCESS_VIEW = "compilation-success";
    public static final String RATING_VIEW = "rating";
